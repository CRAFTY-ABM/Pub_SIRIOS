...
metriccolnames = c("DivLuShannon", "ConsPatches_C", "ConsProp_C", "UnderSupply_Total", "OverSupply_Timber", "OverSupply_Meat",
"RegUnderSupply_Timber", "RegUnderSupply_Meat", "EffSupply", "UnderSupply_Timber", "ConsPatches_NC", 
		"DivLuPerRegSimpson", "DivSupplyPerRegSimpson", "NumActionsNC")

setBmetrics <- c("RegUnderSupply_Meat", "RegUnderSupply_Timber","ConsPatches_NC","ConsPatches_C", "ConsProp_C", "UnderSupply_Total", "OverSupply_Timber")
