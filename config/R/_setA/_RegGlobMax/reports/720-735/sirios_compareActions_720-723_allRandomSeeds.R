...
runIdDescriptions	<- NULL #c("723-1" = "HighThreshold#HighSubsidy", "720-1" =  "LowThreshold#LowSubsidy")
...
simp$fig$height <- 700
simp$fig$width <- 1000
filenameprefix <-  "InstitutionalActionMetrics_ThresholdSubsidyBalanced"
