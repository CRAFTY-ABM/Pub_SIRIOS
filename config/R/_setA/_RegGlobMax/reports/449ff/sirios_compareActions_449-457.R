...
preserve$firstrunid <- 449
preserve$lastrunid	<- 457
preserve$run		<- 449
preserve$seeds		<- c(3)	
...
regionConversion = c("DE14" = "Region B", "Global" = "Global") # "DE13" = "Region A", "DE27" = "Region C",
runIdDescriptions	<- c("449-3" = "No subsidy", "467-3" =  "High subsidy")
...
simp$fig$height <- 700
simp$fig$width <- 1000
filenameprefix <-  "InstitutionalActionMetrics_ActionRuntime"
